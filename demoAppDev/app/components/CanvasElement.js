    ...
    render() {
        return (
            <div className="canvas-div">
                ...
                <img ref="imageCanvas" alt="Embedded Image" width="375" src={this.props.myImage} className="hidden-canvas"></img>
                {/* <img ref="imageCanvas" alt="Embedded Image" src={this.state.busImage} width="100"></img> */}
            </div>
        )
    }
